...
figure('Name','contour for classes A & B','NumberTitle','on');
xx = -2:.1:11; %// x axis
yy = -2:.1:12; %// y axis

[XX YY] = meshgrid(xx,yy); %// all combinations of x, y
...
contour(XX,YY,Z2,'-.');
legend({'Class A','Class B',},'Location','northwest','Orientation','horizontal')
hold off
